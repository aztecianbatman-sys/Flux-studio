...
void FluxNextWindow::buildMenus(){
    ...
    image->addAction(QStringLiteral("Reset Rotation"),this,[this]{m_canvasRotation=0;m_canvasRotation=0;m_canvasRotation=0;m_canvasRotation=0;m_canvas->setCanvasRotation(0);});
