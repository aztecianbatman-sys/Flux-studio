...
private slots:
    ...
    void setLayerLocked(bool enabled); void setLayerClipping(bool enabled); void setLayerAlphaInheritance(bool enabled); void setLayerSolo(bool enabled); void setLayerIsolate(bool enabled); void setLayerLabelColor(); void setLayerStyle(); void syncLayerTreeToDocument();
    void setFrameFromTimeline(int row); void togglePlayback(); void autosave(); void updateBrushSize(int value); void chooseColor(); void setToolFromAction(); void openBrushEditor();
