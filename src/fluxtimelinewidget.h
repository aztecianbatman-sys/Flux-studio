...
private:
    ...
    FluxDocument* m_document{}; FluxAnimationSystem m_animation; int m_current=0; int m_rowHeight=28; int m_frameWidth=18; int m_trackOffset=110; bool m_graph=false;
};
