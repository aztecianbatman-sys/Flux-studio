...
private:
    ...
    QPointF m_lastPoint,m_cursor,m_selectionStart,m_transformStart,m_toolStart; QVector<QPointF> m_lasso; bool m_drawing=false,m_selecting=false,m_onionSkin=false,m_grid=false,m_rulers=false,m_perspective=false,m_transforming=false,m_symmetryH=false,m_symmetryV=false;
